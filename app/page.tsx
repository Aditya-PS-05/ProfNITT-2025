        ...
        <div>
          <div className="relative h-[844px]">
            ...
            <Img
              ...
              height={418}
              alt="Vectorthree"
              className="absolute bottom-[20%] right-[0.53px] m-auto h-[418px] w-[50%] object-contain"
            />
            <Img
          ...
          <div className="relative mt-28 h-[1310px] content-center md:h-auto">
            ...
            /> */}
            <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1 flex-col">
              <ProfNITTToolsSection1 />
              <EmpowermentSection />
            </div>
          </div>
          <ProfNITTToolsSection2 />
          <div className="mt-[164px] flex flex-col items-center mb-20">
            <div className="flex flex-col items-center justify-center self-stretch">
              <div className="relative z-[6] mx-auto w-full max-w-[1274px] rounded-[100px] bg-gradient4 py-[84px] shadow-sm md:py-5">
                <div className="mt-3.5 flex flex-col items-center px-4 md:px-5">
                  <Heading as="h1" className="text-[36px] font-bold text-white-0 md:text-[34px] sm:text-[32px]">
                    JOIN ProfNITT Tools NOW!
                  </Heading>
                  <Separator orientation="horizontal" className="mt-5 h-px w-[34%] bg-gradients" />
                  <Text
                    size="text5xl"
                    as="p"
                    className="mt-5 text-[36px] font-light text-white-0 md:text-[34px] sm:text-[32px]"
                  >
                    Let's Build Your Trading Strategy with ProfNIT Tools
                  </Text>
                  ...
                  <TextArea
                    ...
                    shape="round"
                    className="ml-2 mt-8 w-[90%] rounded-[40px] border-2 !border-white-0 px-3 text-base"
                  />
                  <Button
                    shape="round"
                    className="bg-gradient mt-[50px] w-full min-w-[214px] max-w-[214px] rounded-[24px] px-[34px]"
                  >
                    Login
                  </Button>
                </div>
