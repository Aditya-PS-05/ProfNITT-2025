...
export default async function Home() {
  ...
  return (
    ...
    <div className="w-full bg-blue_gray_900_01 py-9 sm:py-5">
      <div className="mb-1">
        <Header />
        <div>
          ...
          <div className="mt-[164px] flex flex-col items-center">
            <div className="flex w-full max-w-[1274px] flex-col items-center self-stretch md:px-5">
              <div className="rounded-[100px] bg-gradient4 py-[84px] shadow-sm md:py-5">
                <div className="mt-3.5 flex flex-col items-center px-4 md:px-5">
                  ...
                  <Button
                    ...
                    className="mt-[50px] w-full min-w-[214px] max-w-[214px] rounded-[24px] px-[34px]"
                  >
                    Login
                  </Button>
                </div>
